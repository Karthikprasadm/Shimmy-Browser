...
<CardGroup cols={2}>
  <Card href="/browseros/features/chatgpt-pro-oauth">
  ...
  <Card href="/browseros/features/github-copilot-oauth">
...
<Card title="Local Model Guide" icon="server" href="/browseros/features/local-models">
